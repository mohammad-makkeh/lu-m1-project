...
const Index = () => {
    ...
    const onSubmit = async (fv) => {
        ...
        fv.patientAge = parseInt(fv.patientAge);
        ...
        return (
            <div className="w-full h-full grid place-items-center">
                <h1 className="text-6xl font-bold">
                    ...
                    You successfully filled your application for today{" "}
                    {user.username}!
                </h1>
            </div>
        );
    ...
    return (
        <div>
            {isLoading ? (
                ...
                <div className="w-full h-full grid place-items-center text-center py-32">
                    <h1 className="text-2xl flex items-center flex-col gap-9">
                        You successfully filled your application for today{" "}{user.username}!
                        <i className="fa fa-check-circle text-accent text-7xl"></i>
                    </h1>
                </div>
            ) : (
                <>
                    <h1 className="text-xl font-bold mb-6">
                        Hello {user.username}! Fill your resident application
                        for today below.
                    </h1>
                    <Form {...form}>
